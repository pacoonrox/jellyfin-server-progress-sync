...
#pragma warning disable CS1591, CA1001, SA1201, SA1306, SA1401, SA1501, SA1503, SA1513
    ...
    public async Task<AuthenticationResult?> ConfirmAsync(string requestId, Guid actorUserId, string actorAccessToken, bool matches, bool trustDevice)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                if (_configuration.Configuration.TrustedDevicesEnabled && trustDevice && user.GetInactiveLogoutMinutes() == 0)
                {
